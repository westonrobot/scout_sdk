/* 
 * mobile_base_protocol.h
 * 
 * Created on: Jul 24, 2019 02:33
 * Description: evolved from scout_protocol.h
 * 
 * Copyright (c) 2019 Ruixiang Du (rdu)
 */ 

#ifndef MOBILE_BASE_PROTOCOL_H
#define MOBILE_BASE_PROTOCOL_H
