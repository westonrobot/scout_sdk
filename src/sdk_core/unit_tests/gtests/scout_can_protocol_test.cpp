...
struct ScoutCANProtocolTest : testing::Test
{
    ...
    {
        // control frames
        motion_ctrl_frame.can_id = ScoutCANParser::CAN_MSG_MOTION_CONTROL_CMD_ID;
        ...
        motion_ctrl_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motion_ctrl_frame.can_id,
                                                                          motion_ctrl_frame.data,
                                                                          motion_ctrl_frame.can_dlc);

        light_ctrl_frame.can_id = ScoutCANParser::CAN_MSG_LIGHT_CONTROL_CMD_ID;
        ...
        light_ctrl_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(light_ctrl_frame.can_id,
                                                                         light_ctrl_frame.data,
                                                                         light_ctrl_frame.can_dlc);

        // feedback frames
        motion_status_frame.can_id = ScoutCANParser::CAN_MSG_MOTION_CONTROL_STATUS_ID;
        ...
        motion_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motion_status_frame.can_id,
                                                                            motion_status_frame.data,
                                                                            motion_status_frame.can_dlc);

        motion_status_frame2.can_id = ScoutCANParser::CAN_MSG_MOTION_CONTROL_STATUS_ID;
        ...
        motion_status_frame2.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motion_status_frame2.can_id,
                                                                             motion_status_frame2.data,
                                                                             motion_status_frame2.can_dlc);

        light_status_frame.can_id = ScoutCANParser::CAN_MSG_LIGHT_CONTROL_STATUS_ID;
        ...
        light_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(light_status_frame.can_id,
        ...
        system_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(system_status_frame.can_id,
                                                                            system_status_frame.data,
                                                                            system_status_frame.can_dlc);

        motor1_driver_status_frame.can_id = ScoutCANParser::CAN_MSG_MOTOR1_DRIVER_STATUS_ID;
        ...
        motor1_driver_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motor1_driver_status_frame.can_id,
                                                                                   motor1_driver_status_frame.data,
                                                                                   motor1_driver_status_frame.can_dlc);

        motor2_driver_status_frame = motor1_driver_status_frame;
        motor2_driver_status_frame.can_id = ScoutCANParser::CAN_MSG_MOTOR2_DRIVER_STATUS_ID;
        ...
        motor2_driver_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motor2_driver_status_frame.can_id,
                                                                                   motor2_driver_status_frame.data,
                                                                                   motor2_driver_status_frame.can_dlc);

        motor3_driver_status_frame = motor1_driver_status_frame;
        motor3_driver_status_frame.can_id = ScoutCANParser::CAN_MSG_MOTOR3_DRIVER_STATUS_ID;
        motor3_driver_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motor3_driver_status_frame.can_id,
                                                                                   motor3_driver_status_frame.data,
                                                                                   motor3_driver_status_frame.can_dlc);

        motor4_driver_status_frame = motor2_driver_status_frame;
        motor4_driver_status_frame.can_id = ScoutCANParser::CAN_MSG_MOTOR4_DRIVER_STATUS_ID;
        motor4_driver_status_frame.data[7] = ScoutCANParser::Agilex_CANMsgChecksum(motor4_driver_status_frame.can_id,
...
{
    ScoutState state;
    auto msg = ScoutCANParser::UnpackScoutCANFrameToMsg(&motion_status_frame);
...
{
    ScoutState state;
    auto msg = ScoutCANParser::UnpackScoutCANFrameToMsg(&light_status_frame);
    ScoutBase::UpdateScoutState(msg, state);
...
{
    ScoutState state;
    auto msg = ScoutCANParser::UnpackScoutCANFrameToMsg(&system_status_frame);
    ScoutBase::UpdateScoutState(msg, state);
...
{
    ScoutState state;
    auto msg1 = ScoutCANParser::UnpackScoutCANFrameToMsg(&motor1_driver_status_frame);
    auto msg2 = ScoutCANParser::UnpackScoutCANFrameToMsg(&motor2_driver_status_frame);
    auto msg3 = ScoutCANParser::UnpackScoutCANFrameToMsg(&motor3_driver_status_frame);
    auto msg4 = ScoutCANParser::UnpackScoutCANFrameToMsg(&motor4_driver_status_frame);
