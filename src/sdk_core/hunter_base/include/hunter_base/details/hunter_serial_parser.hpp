/* 
 * hunter_serial_parser.hpp
 * 
 * Created on: Aug 07, 2019 12:26
 * Description: 
 * 
 * Copyright (c) 2019 Ruixiang Du (rdu)
 */ 

#ifndef HUNTER_SERIAL_PARSER_HPP
#define HUNTER_SERIAL_PARSER_HPP
...
public:
    ...
    using ReceiveCallback = std::function<void(const HunterStatusMessage &msg)>;
...
private:
    ...
    ReceiveCallback ProcessFrame = std::bind(&HunterSerialParser::DefaultReceiveCallback, this, std::placeholders::_1);

    void ParseChar(uint8_t c);
    uint8_t CalcBufferedFrameChecksum();
    HunterStatusMessage ConstructMessage();

    void DefaultReceiveCallback(const HunterStatusMessage &msg);
};
} // namespace wescore

#endif /* HUNTER_SERIAL_PARSER_HPP */
