...
This software packages provides a C++ interface to communicate with the Scout/Hunter mobile base, for sending commands to the robot and acquiring the latest robot state.
